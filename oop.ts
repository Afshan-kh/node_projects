...
const programStart = async (person: Person) => {
    ...
    do {
        ...
        const ans = await inquirer.prompt({
            ...
            choices: ["Afshan", "Student"]
        });

        if (ans.select === "Afshan") {
            console.log(`You are chatting with ${chalk.bold.green("Afshan")}`);
        ...
        if (ans.select == "Student") {
            ...
            if (!student) {
                ...
                console.log(`I am ${chalk.bold.green(name.name)}, and I am good.`);
                console.log(person.students);
            }
            if (student) {

                console.log(`I am ${chalk.bold.green(student.name)}, and I am good.`);
                console.log(person.students);
            };
        };
    } while (true);
